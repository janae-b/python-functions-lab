...
# print('Answer for Problem-4:', product(-1, 4) # returns -4
# print('Answer for Problem-4:', product(2, 5, 5) # returns -4
# print('Answer for Problem-4:', product(4, 0.5, 5) # returns -4